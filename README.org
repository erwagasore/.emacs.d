...
* ESHELL
  #+begin_src emacs-lisp
    ...
    (+alias 'la     '(exa --all --group --color=always))
    (+alias 'll     '(exa --long --group --color=always))
    (+alias 'l      '(exa --all --all --long --group --header --color=always))
    (+alias 'tree '(exa --tree --long --color=always))
    ;; (+alias 'lt     '(ls -ltr $*))
    (+alias '..     '(cd ..))
    (+alias '...    '(cd ../..))
    (+alias '....   '(cd ../../..))
